...
const FeaturesComponent2 = ({ feature, description }) => {
  return (
    <div className="">
      <div className="flex flex-row items-start lg:flex lg:flex-row lg:items-start space-x-4">
        <div className="inline-flex h-16 w-16 mb-6  items-center justify-center text-white bg-green-500 rounded-lg">
          <svg
            width="24"
            height="21"
            viewBox="0 0 24 21"
